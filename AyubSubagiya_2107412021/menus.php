	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">		
				...
				<li class="nav-item"><a class="nav-link" href="customer.php" id="customer_menu">Pelanggan</a></li>
				<li class="nav-item"><a class="nav-link" href="category.php" id="category_menu">Kategory</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="purchase.php" id="purchase_menu">Pembelian</a></li>
				<li class="nav-item"><a class="nav-link" href="order.php" id="order_menu">Penjualan</a></li>			
			</ul>
		</div>
